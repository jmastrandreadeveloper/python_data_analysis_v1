...
class Class_df_Escuela_ID_Alumno_ID_count:

    def __init__(self):
        return

    def agrupar_df_Escuela_ID_Alumno_ID_count(self , dataframe) -> pd.DataFrame:
    ...
    def filtrar_df_Escuela_ID_Alumno_ID_count(self , Escuela_ID , dataframe) -> int:# Filtrar el DataFrame por Escuela_ID
