...
class GroupNominal():
    ...
    def group(self):        
        ...
        u.save_dataframe_to_csv(self.Agrupado_df_Escuela_ID_Alumno_ID_count,'data/processed/transformed/Nominal/Agrupado_df_Escuela_ID_Alumno_ID_count.csv')        
        u.save_dataframe_to_csv(self.Agrupado_df_lista_de_cursos_normalizados,'data/processed/transformed/Nominal/Agrupado_df_lista_de_cursos_normalizados.csv')
        u.save_dataframe_to_csv(self.Agrupado_df_Escuela_ID_CURSO_NORMALIZADO_Alumno_ID_count,'data/processed/transformed/Nominal/Agrupado_df_Escuela_ID_CURSO_NORMALIZADO_Alumno_ID_count.csv')
        u.save_dataframe_to_csv(self.Agrupado_df_Escuela_ID_CURSO_NORMALIZADO_División_Alumno_ID_count,'data/processed/transformed/Nominal/Agrupado_df_Escuela_ID_CURSO_NORMALIZADO_División_Alumno_ID_count.csv')
        return